...
<body>
  ...
  <div class="container">
    ...
    <h3 style="font-size: 18px;">Dewa 19</h3>

    <div class="section-box">
      <p><strong>Order No.</strong> 1234567890</p>
      <p><strong>Purchased:</strong> Sun, 12 January 2025</p>
    ...
    <div class="section-box">
      <p><strong>Date:</strong> Sat, 01 Feb 2025</p>
      <p><strong>Venue:</strong> The Taman Dayu Park</p>
      <p><strong>Lineup:</strong> Once</p>
