...
<head>
    ...
    <title>Adding New Tickets - FestiPass</title> {{-- Judul halaman juga disesuaikan --}}
...
<body class="bg-white font-sans">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="max-w-lg mx-auto">
            {{-- Sub-header untuk "Adding Ticket" (tetap) --}}
            <div class="text-right mb-4">
                <span class="text-sm text-gray-500">Adding Ticket</span>
            </div>

            <section class="text-center mb-8">
                {{-- PERUBAHAN: Teks judul utama diubah --}}
                <h2 class="text-3xl md:text-4xl font-bold text-purple-700">Adding New Tickets</h2>
            </section>
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                {{-- Tombol Next Dipindahkan ke Tengah --}}
                {{-- PERUBAHAN: justify-end diganti menjadi justify-center --}}
                {{-- Tombol Next diubah menjadi link untuk navigasi kembali --}}
                <div class="flex justify-center pt-4">
                    {{-- PERUBAHAN: Tombol submit diubah menjadi link ke rute 'managetickets.show' --}}
                    <a href="{{ route('managetickets.show') }}"
